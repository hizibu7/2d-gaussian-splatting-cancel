#!/bin/bash
#SBATCH -J f5_s63
#SBATCH -o logs/f5_s63_%j.log
#SBATCH -e logs/f5_s63_%j.log
#SBATCH -t 02:00:00
...
OUT=eval/f5_scan63
rm -rf "$OUT"
python -u train.py -s data/DTU/scan63 -m "$OUT" --depth_ratio 1.0 -r 2 \
  --lambda_dist 1000 --lambda_normal 0.05 --seed 1 --port 26063 \
