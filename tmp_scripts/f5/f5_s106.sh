#!/bin/bash
#SBATCH -J f5_s106
#SBATCH -o logs/f5_s106_%j.log
#SBATCH -e logs/f5_s106_%j.log
#SBATCH -t 02:00:00
...
OUT=eval/f5_scan106
rm -rf "$OUT"
python -u train.py -s data/DTU/scan106 -m "$OUT" --depth_ratio 1.0 -r 2 \
  --lambda_dist 1000 --lambda_normal 0.05 --seed 1 --port 26106 \
